...
### Keyword Spam
#### Types Of  [[#Drug]]s
- [[#Natural Drugs|Natural]]
- [[#Synthetic Drug s|Synthetic]]
- [[#Semi-synthetic Drug s|Semi-synthetic Drugs]]
- [[#Biosynthetic Drug s|Biosynthetic Drugs]] 
...
The liver (and gut wall) removes  [[#Drug]]s by ‘first pass’  metabolism and binding so only a proportion reaches the hepatic veins and the systemic circulation
...
- Oral: Variable  [[#Bioavailability]] (typically 40-90%)  
- Intramuscular (IM): High  [[#Bioavailability]] (75-85%)  
- Subcutaneous: Generally good  [[#Absorption]] (60-80%)
###  [[#Drug]]-Protein
1. Process:  [[#Drug]]s attach to proteins in the bloodstream  
2. Function: Proteins transport and protect  [[#Drug]]s  
3. Release: Controlled  [[#Drug]] distribution to target sites  

This binding determines how effectively  [[#Drug]]s move through the body and reach their intended targets.
...
###  [[#Receptor]]  Interactions
 [[#Agonist]]s Trigger A  [[#Receptor]]s Response
 [[#Antagonist]]s Prevent A  [[#Receptor]]s Response
...
| --------------------------------- | --------------------------- |
|       Polycystic Ovary  [[#Syndrome]]                            |  Age (Risk increases after 45 years)                           |
| Sleep Disorders                   |        Family History ( [[#T2DM]] in close relatives)                     |
...
- If oral medications aren't sufficient to achieve target blood sugar levels. There are rapid-acting, short-acting, intermediate-acting, long-acting, and premixed  [[#Insulin]]s.  
...
1. Amyloid Plaques (Extracellular)  
	- Beta-amyloid proteins clump together outside brain cells due to abnormal cleavage of [[#APP]] by beta-secretase & gamma-secretase  
...
5. Lifestyle factors: Physical inactivity, un [[#Health]]y diet, smoking, and excessive alcohol consumption can increase the risk of Alzheimer's disease
...
2. Cognitive and Neuropsychological Tests  
	- [[#MMSE]] – Assesses memory, orientation, and problem- solving skills.  
	- [[#MoCA]] – Detects mild cognitive impairment.  
...
- Binds to NMDA  [[#Receptor]]s, which are involved in glutamate signalling.  
- Blocking these  [[#Receptor]]s, helps to reduce the overstimulation of glutamate and protect nerve cells from further damage.
...
All [[#Cancer]]s exhibit unregulated [[#cell proliferation]], and if left unchecked, [[#metastasis]]
[[#Cancer]] arises from the accumulation of genetic of [[#Mutation]]s and chromosome defects
Together, they lead to altered gene expression
### Causes of Mutations
#### Spontaneous mutations
- [[#Mutation]]s due to error in replication ofDNA
- Errors introduced during DNA repair
![](https://i.imgur.com/bl2JnZ2.png)
#### Induced mutations
[[#Mutation]]s arise after exposure to [[#Mutagens]]
### How many mutations are cancerous
Six and ten [[#Mutation]]s are needed for a cell to become  [[#Cancer]]ous  
- Minimum burden of [[#Mutation]]s varies according to tumour site
### Categories of Cancer Genes
There are two main categories of genes that influence [[#Cancer]]:
1. [[#Tumor suppressor genes]]
2. [[#Proto-Oncogenes]]
### Types of Cancer
![](https://i.imgur.com/92ZSHfG.png)
1. Sporadic [[#Cancer]] (70-80%):
- Random occurrence
- Environmental factors
- No genetic predisposition
1. Familial [[#Cancer]] (15-20%):
- Family history pattern
- Combination of genetics and environment
- Multiple family members affected
- No specific gene [[#Mutation]] identified
1. Hereditary [[#Cancer]] (5-10%):
- Specific gene [[#Mutation]]s (e.g., BRCA1/2)
...
#### Hereditary Link:
- BRCA1/2 [[#Mutation]]s increase risk for both
- Often co-occur in families
- Known as hereditary breast and ovarian [[#Atherosclerosis]] (HBOC)
- Require comprehensive management strategy
### Breast [[#Atherosclerosis]] Diagnosis
...
##### Tissue Analysis:
- [[#Atherosclerosis]] cell detection
- Tumour classification
- Grade assessment
- Hormone receptor status
- Treatment-determining factors
##### Immunohistochemistry
- Laboratory test performed on breast [[#Cancer]] cells
...
- BRCA1 [[#Mutation]]: 50-70% risk by age 70
- BRCA2 [[#Mutation]]: 40-60% risk by age 70
- Affects both breast and ovarian [[#Cancer]] risk
- Requires intensive screening and monitoring
#### Moderate to High Risk
(25-50%+):
- Risk varies based on specific [[#Mutation]]s
...
- Protects cellular DNA from carcinogenic damage and [[#Mutation]]s
...
#### Limitations
Genetic testing for BRCA1 and BRCA2 does not identify all causes of hereditary breast or ovarian [[#Cancer]]
...
|      | More likely to progress to [[#myocardial infarction]]|




Both cause [[#myocardial ischaemia]]

### [[#Diagnosis|diagnosis]]  
#### Electrocardiogram    
ST segment depression Due to [[#myocardial ischaemia]]  
His [[#ECG]] showed some  [[#Signs]] of [[#myocardial ischaemia]], but no permanent cardiac damage.
...
- Inject a sympathomimetic  
	- Activates adrenergic  [[#Receptor]]s  
	- Increase force of contraction (inotropy) and heart rate (chronotropy) – mimics exercise  

### Risk Factors for Developing CAD - [[#Aetiology|aetiology]]  
...
#### Anxiety  
Anxiety  [[#Symptoms]] are often a hallmark of [[#Perimenopause]] and are more likely to occur in those with a pre-existing [[#Diagnosis|diagnosis]] or sensitivity towards anxiety.  
...
- Progesterone  [[#Receptor]]s are also found within the brain, and reduced levels of progesterone, although not seen to have a consistent impact on psychological well-being, can have an impact on menopausal symptomology which would otherwise lead to an increase in psychological distress.
...
### [[#Diagnosis|diagnosis]] of [[#Perimenopause]]
In the UK, the [[#Diagnosis|diagnosis]] of [[#Perimenopause]] is typically based on clinical evaluation and assessment of  [[#Symptoms]], as well as consideration of a woman's age and menstrual history:  
...
- Several classes of antidepressant are available; [[#SSRIs]] are  generally the most commonly prescribed.  
- A patient requiring an antidepressant for a first major  depressive episode will generally receive  monotherapy

#### selective serotonin re-uptake inhibitors
- The [[#SSRIs]] are thought to restore the levels of serotonin in the synaptic cleft by binding at the serotonin re-uptake transporter preventing the re-uptake and subsequent  degradation of serotonin.  
...
- Heals spontaneously  
- CXR normal  
- Result from  [[#Health]] reactivation of latent infection  
...
- In children Asymptomatic state may cause miliary tuberculosis and[[#TB]] meningitis

### [[#TB]] and AIDS/HIV  
- People with active[[#TB]] are more likely to have HIV than the general population  
-[[#TB]] can appear at any stage of HIV infection  
- Early: Typical pattern of upper lobe infiltrate  
- [[#Diagnosis|diagnosis]] can be difficult
...
5. Microbiological testing
	- When a patient presents with respiratory  [[#Symptoms]] first line of  diagnostics is often a chest x-ray
...
#### Interferon Gamma Release Assays (IGRAs):  
IGRAs detect[[#TB]] infection by measuring the release of interferon-gamma (IFN-g) from patient T cells after stimulation of a whole blood sample with highly specific[[#TB]] antigens
...
- Reduce transmission of [[#Mycobacterium tuberculosis]] to other people
...
- A trained  [[#Health]]-care worker watches a patient swallow each  [[#Dose]] of anti-[[#TB]] [[#Drug]]s and documents it.  
...
Sarah is diagnosed with [[#Pulmonary Tuberculosis]] , based on her clinical  
...
duration of six months. The initial phase may include four  [[#Drug]]s (isoniazid, rifampin,  
...
treatment response and prevent potential  [[#Side Effect]]s. Contact tracing will also be  
...
Example: The aetiology of type 2 diabetes involves a combination of genetic predisposition and lifestyle factors, primarily obesity, physical inactivity, and un [[#Health]]y diet.  
#### Chronic  
...
[[#Diagnosis|diagnosis]] is [[#Myocardial Infarction]] (heart attack).  
#### Disease  
...
Example: Genetic disorders: Cystic fibrosis, sickle cell anaemia (caused by gene [[#Mutation]]s) or hormonal imbalances: Hypothyroidism .  
#### Exogenous  
...
Social  [[#Health]]: Ability to form and maintain  [[#Health]]y relationships.  
#### Homeostasis  
...
Example: Adverse  [[#Drug]] reactions ( [[#Side Effect]]s), infections acquired during hospitalisation (nosocomial infections), or  [[#Complication]]s from surgery.  
#### Lesion  
...
#### Morbidity  
Refers to the state of being diseased or un [[#Health]]y.  
...
Example: The  [[#Predisposing Factors]] of heart failure involves the heart's inability to pump enough blood to meet the body's needs, leading to fluid buildup in the lungs and other tissues, shortness of breath, and fatigue  
...
#### Premalignant  
Refers to a condition or  [[#Lesion]] that has the potential to become malignant ([[#Cancer]]ous).  
Example: Examples of  [[#Premalignant]] conditions include certain types of colon polyps  
#### Prognosis  
The predicted course and outcome of a disease. It's a forecast of the likely progression, duration, and potential for recovery or  [[#Complication]]s.  
...
Example: A patient with leukaemia who goes into  [[#Remission]] after chemotherapy but then experiences a return of [[#Cancer]]ous cells in the blood has relapsed.  
#### Remission  
...
#### Signs  
Objective findings that can be observed or measured by a  [[#Health]]care professional during a physical examination or through diagnostic tests.  
...
#### Pharmacokinetics
What the body does to a  [[#Drug]] (How and Where)
#### Contraindiction
a factor that makes a particular treatment or procedure inadvisable due to the risk of harm it could pose to the patient.
#### Toxic effect
a harmful consequence caused by a substance, whether a chemical,  [[#Drug]], or other agent, that is harmful to a living organism
#### Harmful Consequences
 [[#Toxic effect]]s are the negative impacts that a substance has on an organism. These impacts can be at the cellular level (cytotoxicity), organ level (e.g., hepatotoxicity - liver damage), or at the level of the whole organism.
#### Xenobiotic Response
 [[#Toxic effect]]s are often triggered by xenobiotic substances, meaning substances that are foreign to the body.
#### Protective Responses
While often viewed as negative, some  [[#Toxic effect]]s can be seen as protective responses by the body to eliminate the harmful substance. 
#### Acute Toxicity
These effects occur rapidly after a single or short-term exposure, and are often reversible. Examples include hangovers from alcohol consumption or  [[#Poisoning]]  [[#Symptoms]] from a single exposure to a toxic substance. 
#### Chronic Toxicity
These effects develop gradually over time, often from repeated or prolonged exposure, and can be irreversible. Examples include liver damage from long-term alcohol abuse or lung [[#Cancer]] from smoking. 
#### Local  Toxic effects
...
#### Absorption
How readily a substance is absorbed into the body affects the potential for toxicity. The  [[#Drug]] moving into the body from an external source
#### Metabolism and Elimination
The body's ability to process and eliminate a substance also influences toxicity. 
#### Dose
The amount of substance to which an individual is exposed can significantly impact the severity of the  [[#Toxic effect]]. 
####  Drug Toxicity
Over [[#Dose]]s or adverse reactions to medications can lead to  [[#Toxic effect]]s. 
#### Environmental Toxins
Exposure to pollutants like heavy metals or certain pesticides can cause  [[#Toxic effect]]s. 
#### Poisoning
Ingestion or exposure to poisonous substances can result in severe  [[#Toxic effect]]s. 
#### Adverse Effect
A broader term encompassing any harmful, undesired outcome from a medication or other medical intervention. This could include  [[#Symptoms]],  [[#Complication]]s, or even death. 
#### Side Effect
A specific type of  [[#Adverse Effect]]. It's considered a consequence of the primary therapeutic action of a  [[#Drug]]. For example, a common side effect of an anti-inflammatory  [[#Drug]] might be stomach upset, which is a consequence of the  [[#Drug]]'s action on the body. 
#### Complication
Similar to  [[#Adverse Effect]], but may be used in situations where the negative effect is expected or common, such as with surgery. 
#### Medical Error
If the negative effect results from an unsuitable dosage or procedure, it's not considered an  [[#Adverse Effect]], but rather a  [[#Drug]]. 
#### Therapeutic Effect
the intended beneficial effects of the  [[#Drug]]
#### Drug
Any substance that causes a change in your body's function
#### Medicine
A  [[#Drug]] that has gone through FDA approval used to treat, prevent, or diagnose disease
#### Bioavailability
The proportion of administered  [[#Drug]] that reaches systemic circulation, relative to IV administration. (This Determines  [[#Drug]] effectiveness)
#### Lipophilic 
...
#### Receptor
a macromolecule in the membrane or in the cell that chemically binds a ligand ( [[#Drug]]).
Unoccupied  [[#Receptor]]s dont influence intracellular processes.
 [[#Drug]] And A  [[#Receptor]] complex causes a Response
#### Agonist
...
#### Affinity  
How well a  [[#Drug]] binds to a  [[#Receptor]], measured as the concentration the  [[#Drug]] occupying 50% of receptors  
Higher  [[#Affinity]], lower dissociation constant ( [[#DK]])
#### DK 
Dissociation Constant (Higher Dissociation Constant, lower  [[#Affinity]] ( [[#DK]]))
#### Efficacy  
...
#### Type 2 diabetes mellitus
A complex metabolic disorder characterised by  [[#hyperglycaemia]] Arising from A Combination Of  [[#Insulin Resistance]] And  [[#Insulin]] deficiency.
This prevents the uptake of  [[#Glucose]] 
#### Glucose
...
#### Insulin
a hormone produced by the pancreas That allows  [[#Glucose]] to enter cells (through blood), for energy.
#### Insulin Resistance
Cells Not responding to  [[#Insulin]] Through  [[#Reduced tissue sensitivity]] And  [[#Increased glucose production]]
#### Reduced tissue sensitivity
Cells in muscles, fat, and liver become less responsive to  [[#Insulin]] decreasing  [[#Glucose]] uptake and utilisation.
#### Increased  Glucose production
The liver produces more  [[#Glucose]], contributing to  [[#hyperglycaemia]]
#### Impaired  Insulin Secretion
 [[#Beta-cell dysfunction]] And  [[#Progressive decline]]
#### Beta-cell dysfunction
The pancreatic beta cells gradually lose their ability to secrete enough  [[#Insulin]] to overcome resistance.
#### Progressive decline
Cell function deteriorates worsening  [[#hyperglycaemia]]
#### Hypertension
High Blood Pressure
...
Due to impaired immune function and high blood sugar, individuals with  [[#T2DM]] are more prone to infections (UTIs and respiratory)
#### Gum & Dental Problems
...
- Animals
	- E.g.  [[#Insulin]] from pork/beef, Cod liver oil from Cod fish liver.
- Minerals 
...
- Prepared by chemical modification of natural  [[#Drug]]s.
...
#### Glycated Haemoglobin Test
HbA1c provides an average of blood  [[#Glucose]] over 2–3 months due to the lifespan of red blood cells being 120 days. 6.5% or higher indicates diabetes. 
#### FPG Test
...
#### Sitagliptin
Enhance  [[#Insulin]] secretion and reduce glucagon secretion
#### Linagliptin
Increase incretin hormone levels, which enhance  [[#Insulin]] release and  decrease glucagon secretion
#### Polydipsia
Increased Thirst
#### Polyuria
Frequent Urination
...
#### Lifestyle modifications  
Maintaining a  [[#Health]]y lifestyle with regular exercise, a balanced diet, and social engagement can also help support brain  [[#Health]] and potentially slow down the progression of Alzheimer's.
#### Angina Pectoris
...
[[#Electrocardiogram]]
#### Perimenopause
Refers to the transitional phase that women experience before reaching [[#menopause]] (Typically 40+). It typically begins (and lasts for) several years before [[#menopause]] as it marks the gradual decline in ovarian function and hormone production.  
#### menopause
